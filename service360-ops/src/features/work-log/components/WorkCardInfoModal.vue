...
const updateDefectCoordinates = (newCoordinates) => {
  ...
  if (inspectionBounds.value && inspectionBounds.value.StartKm !== null) {
    ...
    const objectStartCoordinates = (inspectionBounds.value.StartKm || 0) * 1000 + (inspectionBounds.value.StartPicket || 0) * 100 + (inspectionBounds.value.StartLink || 0) * 25;
    const objectFinishCoordinates = (inspectionBounds.value.FinishKm || 0) * 1000 + (inspectionBounds.value.FinishPicket || 0) * 100 + (inspectionBounds.value.FinishLink || 0) * 25;
  ...
  if (activeTab.value === 'defects') {
    ...
    try {
      ...
      const dataToSave = {
        ...
        pvLocationClsSection: (props.record.rawData?.pvLocationClsSection !== null && props.record.rawData?.pvLocationClsSection !== undefined) ? parseInt(props.record.rawData.pvLocationClsSection) : parseInt(props.sectionPv),
        objLocationClsSection: (props.record.rawData?.objLocationClsSection !== null && props.record.rawData?.objLocationClsSection !== undefined) ? props.record.rawData.objLocationClsSection : props.sectionId,
