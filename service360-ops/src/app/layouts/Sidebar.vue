...
const allItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Планирование ресурсов', path: '/resource-planning', permission: 'res' }
    ]
  },
  {
    label: 'Исполнение',
    icon: 'CheckSquare',
    children: [
      { label: 'Журнал работ', path: '/work-log', permission: 'ftl' },
      ...
      { label: 'Импорт данных путеизмерителя', path: '/track-gauge-import', permission: 'imp'  }
    ]
  },
  {
    label: 'Отчеты',
